                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('book.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="book_title" type="text" class="form-control @error('book_title') is-invalid @enderror" name="book_title" autofocus>
                                        @error('book_title')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="book_isbn" type="integer" class="form-control @error('book_isbn') is-invalid @enderror" name="book_isbn" autofocus>
                                        @error('book_isbn')
                                        <span role="alert" class="invalid-feedback">
                                            <strong>*{{$message}}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <input id="book_pages" type="integer" class="form-control @error('book_pages') is-invalid @enderror" name="book_pages" autofocus>
                                    @error('book_pages')
                                    <span role="alert" class="invalid-feedback">
                                        <strong>*{{$message}}</strong>
                                    </span>
